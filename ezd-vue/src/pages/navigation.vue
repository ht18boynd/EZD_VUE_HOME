  ...
  <nav class="border-bottom sticky-header">
    <div class="navigation-wrapper container flex-space-between align-items-center">
      <ul class="navigation-menu">
        ...
        <li class="menu-item menu-item-has-children"><a class="menu-link" href="#">Product<span class="indicator"><svg class="crumina-icon">
          <use xlink:href="#arrow-down-icon"></use>
        </svg></span></a>
        <ul class="submenu">
              ...
              <div class="megamenu-column">
                ...
                <div class="flex-space-between">
                  ...
                  <ul class="submenu-column">
                    ...
                    <li class="menu-item"><a href="14-blog-post-centered.html" class="menu-link">Blog post
                        centered</a></li>
                    <li class="menu-item"><a href="15-blog-post-sidebar.html" class="menu-link">Blog post sidebar</a></li>
              ...
              <div class="megamenu-column">
                ...
                <div class="flex-space-between">
                  <ul class="submenu-column">
                    ...
                    <li class="menu-item"><a href="09-profile-page-about.html" class="menu-link">Profile page about</a></li>
...
<li class="menu-item"><a href="28-checkout.html" class="menu-link">Checkout</a></li>
                  ...
                  <ul class="submenu-column">
                    ...
                    <li class="menu-item"><a href="18-connect-a-wallet.html" class="menu-link">Connect a wallet</a></li>
        ...
        <li class="menu-item menu-item-has-children"><a class="menu-link" href="#">Blog<span class="indicator"><svg class="crumina-icon">
          <use xlink:href="#arrow-down-icon"></use>
        </svg></span></a>
        <ul class="submenu">
