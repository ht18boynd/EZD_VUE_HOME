        ...
        <div class="cs-slider cs-style1">
          <div class="cs-slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0" data-slides-per-view="1">
            <div class="cs-slider_wrapper">
              <div class="cs-slide">
                <div class="cs-hero cs-style1 cs-bg cs-center" data-src="assets/img/hero_bg1.jpeg">
                  <div class="container">
                    <div class="cs-hero_text">
                      <h1 class="cs-hero_title">The Best Beneficial Place <br>to Collect , Buy and Sell <br>NFT Marketplace</h1>
                      <div class="cs-hero_subtitle cs-medium">Secure and secret NFTs for gaming, entertainment, metaverse and data <br>management time capsules.</div>
                ...
                <div class="cs-hero cs-style1 cs-bg cs-center" data-src="assets/img/hero_bg1.jpeg">
                  <div class="container">
                    <div class="cs-hero_text">
                      ...
                      <div class="cs-hero_subtitle cs-medium">Secure and secret NFTs for gaming, entertainment, metaverse and data <br>management time capsules.</div>
                      <div class="cs-hero_btns">
                        <a href="#" class="cs-hero_btn cs-style1 cs-color1">Explore</a>
                        <a href="#" class="cs-hero_btn cs-style1 cs-color2">Create</a>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <section>
      <div class="container">
        <div class="cs-cta cs-style2 text-center cs-accent_bg">
          ...
          <a href="/home/register" class="cs-btn cs-style1 cs-btn_lg cs-color2"><span>Sign Up</span></a>
        </div>
      </div>
    </section>
    <!-- End CTA -->
...
<script>
import endCategory from '@/pages/endCategory.vue';
import footerHome from '@/pages/footer.vue';
import iconBox from '@/pages/iconBox.vue';
import liveAction from '@/pages/liveAction.vue';
import logoCarousel from '@/pages/logoCarousel.vue';
import newItem from '@/pages/newItem.vue';
import startCategory from '@/pages/startCategory.vue';
import startCollection from '@/pages/startCollection.vue';
...
export default {
  name: "homeEZD",
  components: {
    endCategory,footerHome,iconBox,liveAction,logoCarousel,newItem,startCategory,startCollection,startHeader
  },
  data() {
    return {
      // gamelist: [],
