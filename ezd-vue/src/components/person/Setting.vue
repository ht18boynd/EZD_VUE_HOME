    ...
    <div class="container">
      ...
      <div class="cs-prifile_wrap">
        ...
        <div class="cs-profile_right">
          ...
          <form class="row" @submit.prevent="updatePasswordUser">
            <div class="col-lg-6">
              <div class="cs-form_field_wrap">
                <input
                  type="password"
                  class="cs-form_field cs-white_bg"
          ...
          <div class="cs-height_30 cs-height_lg_30"></div>
          <h2 class="cs-section_heading cs-style1">Change Profile Info</h2>
          <div class="cs-height_25 cs-height_lg_25"></div>
          <form class="row">
            <div class="col-lg-6">
              <div class="cs-form_field_wrap">
          ...
          <form enctype="multipart/form-data">
            <span>Danh Sách avartar :</span>
            <div class="cs-edit_profile"  v-if="avatars != null">
              <div class="cs-edit_profile_img"    v-for="avatar in avatars"
              :key="avatar.id">
              <img :src="avatar" alt="" class="cs-zoom_item" />
              </div>
              <div class="cs-edit_profile_right">
                <div class="cs-edit_profile_btns">
                  <a href="#" class="cs-upload_btn">Upload</a>
                  <span class="cs-delete_btn"
...
export default {
  ...
  created() {
    ...
    console.log("avartas : " + this.avatars);
  },
  methods: {
    async updatePasswordUser() {
      try {
        // Thực hiện cập nhật mật khẩu
        await RegisterService.updatePassword(
        ...
        const newRespone = await RegisterService.findByEmail(this.userInfoData.email);
        this.$store.commit('setUserInfo', newRespone);

        // Hiển thị thông báo thành công
        Swal.fire("Change Password Success!", "Change Password Success!", "success");

        // Reset trường email (nếu cần)
        this.currentPassword = "";
        this.newPasword = "";
        ...
        Swal.fire(
          ...
          "Old Password Not Correct. Please try again!",
          "error",
        );
      }
    },
