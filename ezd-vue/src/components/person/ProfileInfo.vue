          ...
          <div class="row">
            <div class="col-lg-6">
              ...
              <div class="cs-form_field_wrap">
                <div class="cs-form_field cs-white_bg">
                  {{ userInfoData.name }}
                </div>
              </div>
              <div class="cs-height_25 cs-height_lg_25"></div>
              ...
              <div class="cs-form_field_wrap">
                <div
                  ...
                  v-if="userInfoData.phoneNumber != null"
                >
                  {{ userInfoData.phoneNumber }}
                </div>
                <div class="cs-form_field cs-white_bg">Chưa có thông tin</div>
              </div>
              <div class="cs-height_20 cs-height_lg_20"></div>
              <span>Danh Sách avartar :</span>
              <div class="cs-edit_profile" v-if="avatars != null">
                <div
                  class="cs-edit_profile_img"
              ...
              <div class="cs-edit_profile" v-else>Chưa có avarta</div>
            </div>
            <div class="col-lg-6">
              <span>Địa Chỉ :</span>
              <div class="cs-form_field_wrap">
                <div
                  class="cs-form_field cs-white_bg"
                  v-if="
                    userInfoData.address != null || userInfoData.country != null
                  "
                >
                  {{ userInfoData.address }} - {{ userInfoData.country }}
                </div>
                <div class="cs-form_field cs-white_bg" v-else>
                  Chưa có thông tin
                </div>
              </div>
              <div class="cs-height_25 cs-height_lg_25"></div>
