      ...
      <div class="col-lg-8 offset-lg-2">
        <div class="cs-contact_card_wrap">
          <div class="cs-contact_card">
            ...
            <div class="cs-contact_info text-center">
              ...
              <p class="cs-contact_text"> 590 Cách Mạng Tháng Tám, Phường 11, Quận 3, TP. HCM</p>
            </div>
          </div>
        </div>
        ...
        <div class="cs-contact_box">
          <div class="cs-section_heading cs-style4">
            <h2 class="cs-section_title">Register to become the Idol</h2>
            ...
            <div class="row">
              ...
              <div class="col-lg-12">
                ...
                <div v-if="isCheckMax" class="alert alert-warning">
                 Tỉ Lệ Từ Chối Cao :{{ maxCheckProbability.toFixed(2) }}% Vui Lòng Cập Nhập Lại Ảnh 
                 <img width="48" height="48" src="https://img.icons8.com/color/48/000000/warning-shield.png" alt="warning-shield"/>
                </div>           
              </div>
              <div class="col-lg-12">
                <div class="cs-form_field_wrap">
          ...
          <div class="cs-bid_card">
            ...
            <div class="cs-bid_info">
              ...
              <div class="cs-bid_form_head">
                ...
                <span
                  >Quantity 2
                  <span class="cs-accent_color">Available</span></span
                >
              </div>
