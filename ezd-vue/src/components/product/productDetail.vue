          ...
          <div class="col-lg-12 col-sm-4 col-6">
            ...
            >
              <div class="cs-card_thumb">
                ...
                <div class="cs-team_image" style="border-radius: 50%">
                  <img :src="avartar" alt="Image" />
                </div>
      ...
      <div class="col-lg-8">
        ...
        <div class="cs-tabs cs-fade_tabs cs-style1">
          ...
          <div class="cs-tab_content">
            ...
            <!-- .cs-tab -->
            <div id="tab_two" class="cs-tab"></div>
            <!-- .cs-tab -->
          </div>
        </div>
        <div class="cs-height_30 cs-height_lg_30"></div>
              ...
              <div class="comment-body">
                ...
                <div class="reply"><a class="comment-reply-link" href="#">
                  ...
                  <svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1 5.74707H8.5C10.0913 5.74707 11.6174 6.37921 12.7426 7.50443C13.8679 8.62965 14.5 10.1558 14.5 11.7471V13.2471M1 5.74707L5.5 10.2471M1 5.74707L5.5 1.24707" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                  </svg>                    
                </a></div>
              </div>
              <ol class="children">
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-4">
        <div class="cs-post cs-style1">
          <a href="blog-details.html" class="cs-post_thumb">
            <div class="cs-post_thumb_in cs-bg" data-src="assets/img/general/general_16.jpeg"></div>
          </a>
          <div class="cs-post_info">
            <h2 class="cs-post_title"><a href="blog-details.html">Guide to Making, Buying and Selling NFT</a></h2>
            <div class="cs-post_subtitle">It is a long established fact that a reader will be
              ...
              <div class="cs-post_avatar">
                <a href="#" class="cs-post_avatar_img"><img src="assets/img/avatar/avatar_18.png" alt="Avatr"></a>
      ...
      <div class="col-lg-4">
        <div class="cs-post cs-style1">
          <a href="blog-details.html" class="cs-post_thumb">
            <div class="cs-post_thumb_in cs-bg" data-src="assets/img/general/general_17.jpeg"></div>
          </a>
          <div class="cs-post_info">
            ...
            <div class="cs-post_subtitle">It is a long established fact that a reader will be
              ...
              <div class="cs-height_20 cs-height_lg_20"></div>
              <div class="cs-post_avatar">
                <a href="#" class="cs-post_avatar_img"><img src="assets/img/avatar/avatar_19.png" alt="Avatr"></a>
                <div class="cs-post_avatar_right">
      ...
      <div class="col-lg-4">
        <div class="cs-post cs-style1">
          <a href="blog-details.html" class="cs-post_thumb">
            <div class="cs-post_thumb_in cs-bg" data-src="assets/img/general/general_18.jpeg"></div>
          </a>
          <div class="cs-post_info">
            <h2 class="cs-post_title"><a href="blog-details.html">Why do NFTs even make sense?</a></h2>
            <div class="cs-post_subtitle">It is a long established fact that a reader will be
